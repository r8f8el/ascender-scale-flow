...
-- Corrigir a URL do convite para usar o domínio correto da aplicação
...
BEGIN
  ...
  -- Generate invite URL pointing to the signup page with correct domain
  invite_url := 'https://loving-lacework-434619.lovableproject.com/convite-equipe/cadastro?token=' || secure_token;
