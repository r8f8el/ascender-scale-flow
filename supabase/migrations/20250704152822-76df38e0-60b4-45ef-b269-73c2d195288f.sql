...
-- Primeiro, vamos inserir os usuários mock na tabela auth.users do Supabase
-- Isso permitirá que eles façam login através do Supabase Auth

-- Inserir o usuário Portobello
...
-- Inserir os perfis de cliente correspondentes
