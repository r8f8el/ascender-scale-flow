...
ALTER TABLE IF EXISTS public.fpa_clients DROP CONSTRAINT IF EXISTS fk_fpa_clients_profile;
ALTER TABLE IF EXISTS public.fpa_reports DROP CONSTRAINT IF EXISTS fk_fpa_reports_client;
