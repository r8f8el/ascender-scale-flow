...
ALTER TABLE public.fpa_clients DROP CONSTRAINT IF EXISTS unique_fpa_client_profile;
ALTER TABLE public.fpa_clients ADD CONSTRAINT unique_fpa_client_profile UNIQUE (client_profile_id);
